<template>
  <section id="intro">
    <div class="intro">
      ...
      <p class="wedding-day">{{ weddingDaySplit }}</p>
      <div class="d-day">
...
<script>
import DdayCount from './DdayCount.vue';
...
export default {
  ...
  data() {
    return {
      weddingDay: '2023-09-09',
    }
  },
  computed: {
    weddingDaySplit() {
      return this.weddingDay.replaceAll('-', '.')
    },
  },
}
</script>
  ...
  section#intro {
    ...
    .intro {
      ...
      .wedding-name {
        ...
        animation: alternate 2s intro-name-animation;
        strong{
          font-size:1.2rem;
        }
        .sujin{
    ...
    @keyframes intro-name-animation {
      0% {
        opacity: 0;
